...
# in the entire company until year 2002, and add a filter allowing 
...
# 4
# Create an SQL stored procedure that will allow you to 
# obtain the average male and female salary per department
# within a certain salary range. Let this range be defined by two values
